 ...
 * @author Marcos
 */
public class Jjm_JDlgConsultaProdutos extends javax.swing.JDialog {

    /**
     * Creates new form JDlgUsuariosPesquisar
     */
    Jjm_ControllerConsultasProdutos controllerConsultasProdutos;
    ProdutosDAO produtosDAO;

    public Jjm_JDlgConsultaProdutos(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        setLocationRelativeTo(null);
        setTitle("Consulta Produtos da Taylor");
        controllerConsultasProdutos = new Jjm_ControllerConsultasProdutos();
    ...
    private void jBtnConsultaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtnConsultaActionPerformed
        ...
        if (!jTxtValor.getText().isEmpty() && !jTxtNome.getText().isEmpty()) {
            ...
            controllerConsultasProdutos.setList(listaNomeValor);
            
        } else if (!jTxtNome.getText().isEmpty()) {
            String nome = jTxtNome.getText();
            
            List listNome = (List) produtosDAO.listNome(nome);
            controllerConsultasProdutos.setList(listNome);
            
        } else if (!jTxtValor.getText().isEmpty()){
            double valor = Util.strToDouble(jTxtValor.getText());
            
            List listaValor = (List) produtosDAO.listValor(valor);
            controllerConsultasProdutos.setList(listaValor);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Jjm_JDlgConsultaProdutos.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Jjm_JDlgConsultaProdutos dialog = new Jjm_JDlgConsultaProdutos(new javax.swing.JFrame(), true);

 ...
 * @author Marcos
 */
public class Jjm_JDlgConsultaClientes extends javax.swing.JDialog {

    /**
     * Creates new form JDlgUsuariosPesquisar
     */
    Jjm_ControllerConsultasClientes controllerConsultasClientes;
    ClientesDAO clientesDAO;

    public Jjm_JDlgConsultaClientes(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        setLocationRelativeTo(null);
        setTitle("Consulta Clientes da Taylor");
        controllerConsultasClientes = new Jjm_ControllerConsultasClientes();
    ...
    private void jBtnConsultaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtnConsultaActionPerformed
        ...
        if (!jTxtValor.getText().isEmpty() && !jTxtNome.getText().isEmpty()) {
            ...
            String ativo = jTxtValor.getText();
            
            List listNomeAtivo = (List) clientesDAO.listNomeAtivo(nome, ativo);
            controllerConsultasClientes.setList(listNomeAtivo);
            
        } else if (!jTxtNome.getText().isEmpty()) {
            String nome = jTxtNome.getText();
            
            List listNome = (List) clientesDAO.listNomes(nome);
            controllerConsultasClientes.setList(listNome);
            
        } else if (!jTxtValor.getText().isEmpty()){
            String ativo = jTxtValor.getText();
            
            List listAtivo = (List) clientesDAO.listAtivo(ativo);
            controllerConsultasClientes.setList(listAtivo);
    ...
    try {
        ...
        job.setJobName("Relatorio Clientes da taylor ");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Jjm_JDlgConsultaClientes.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Jjm_JDlgConsultaClientes dialog = new Jjm_JDlgConsultaClientes(new javax.swing.JFrame(), true);
